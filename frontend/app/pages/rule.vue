    ...
    <div class="container mx-auto text-left text-sm">
        ...
        <ul class="ml-4 list-disc space-y-2">
          <li>
            ...
            <ul class="my-2 ml-6 list-disc">
              ...
              <li>ログは独り言を含め、ゲーム終了後に全て公開されます。他の方が参加したくなるようなログを作っていきましょう。</li>
            </ul>
          </li>
        </ul>
        <ul class="mt-4 ml-4 list-disc space-y-2">
          ...
          <li>
            ...
            <ul class="my-2 ml-6 list-disc">
              <li>例. 役職希望への言及</li>
              <li>
                例. システムメッセージやシステムに表示されている内容のコピペ
              </li>
            </ul>
          </li>
          <li>
            正常な運営を妨げる行為や管理者が不快に感じる行為がなされた場合、アクセス禁止措置等が取られる可能性があります。
                        <ul class="my-2 ml-6 list-disc">
              <li>例. 煽り、暴言</li>
              <li>
                例. 複数アカウントでの参加
      ...
      <div>
        <ul class="ml-4 list-disc space-y-2">
          ...
          <li>
            推理発言内容を背景色と同化させて隠す、cwで隠すなど、裏技っぽいことは禁止します。ロールプレイや発言のわかりやすさを補助するために使ってください。
          </li>
        </ul>
      </div>
